...
def is_map(t: DataType) -> TypeGuard[MapType]: ...
def is_list(t: DataType) -> TypeGuard[ListType]: ...
def is_large_list(t: DataType) -> TypeGuard[ListType]: ...
def is_fixed_size_list(t: DataType) -> TypeGuard[FixedSizeListType]: ...
