...
import pandas as pd
from textual_fastdatatable import DataTable as FastDataTable, ArrowBackend

BENCHMARK_DATA_FILE = Path(__file__).parent.parent.parent / "tests" / "data" / "lap_times.parquet"
